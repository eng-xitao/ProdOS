...
export default function EtapasComercialPage() {
  ...
  async function removeStage(id) {
    ...
    await supabase.from("opportunity_stages").delete().eq("id", id);
    loadStages();
  }
  ...
  return (
    <div>
      <header style={{ marginBottom: 20 }}>
        <h1 style={styles.title}>Etapas do Funil Comercial</h1>
        <p style={styles.subtitle}>
          Configure as etapas do seu processo de vendas — pode ser "Prospecção, Proposta,
          Negociação, Fechado" ou o que fizer sentido para o seu negócio.
        </p>
      </header>
      ...
      <form onSubmit={addStage} style={styles.form}>
        <input
          ...
          placeholder="Ex: Prospecção, Proposta enviada, Negociação..."
        />
