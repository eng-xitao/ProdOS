...
const STATUS_COLOR = { rascunho: "var(--text-dim)", enviado: "#2563EB", aprovado: "var(--green)", rejeitado: "var(--red)", convertido: "var(--amber)" };
...
const styles = {
  header:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:16,marginBottom:20}, title:{margin:0,fontSize:28}, subtitle:{margin:"6px 0 0",color:"var(--text-dim)"}, addBtn:{border:0,borderRadius:9,padding:"11px 16px",background:"var(--amber)",color:"white",fontWeight:700,cursor:"pointer"},
  ...
  linkBtn:{border:0,background:"transparent",color:"var(--amber)",fontWeight:800,cursor:"pointer",padding:0,textDecoration:"underline"},
};
